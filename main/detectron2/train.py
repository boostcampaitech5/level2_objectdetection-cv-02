...
def parse_args():
    ...
    parser.add_argument('--config_path', type=str, default='COCO-Detection', help='select config path (default : COCO-Detection/) if you use tridentnet, set tridentnet')
    parser.add_argument('--model', type=str, default='faster_rcnn_R_101_FPN_3x', help='train model name (default : faster_rcnn_R_101_FPN_3x) if you use tridentnet, set tridentnet_fast_R_101_C4_3x.yaml ')
